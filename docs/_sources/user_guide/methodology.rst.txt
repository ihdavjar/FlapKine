...
.. list-table:: Main Object-Oriented Components
   ...
   * - ``Sprite``
     - Encapsulates time-series data for a single ``Object3D``. Stores dynamic parameters like center of mass, Euler angles, and deformation.
   * - ``Scene``
...
📚 For details on mathematical models (e.g., inverse kinematics, axis projections, and deformation strategies), see the :doc:`Transform Reference <user_guide/transform_reference>`.
