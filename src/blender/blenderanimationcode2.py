...
output_dir = os.path.join(os.getcwd(), 'data/images')  # Output directory

# List of STL file paths
stl_files_dir = os.path.join(os.getcwd(), 'data/stl')  # STL files directory


# Set rendering parameters
bpy.context.scene.render.image_settings.file_format = 'PNG'  # Output image format
bpy.context.scene.render.resolution_x = 640  # Output resolution X
bpy.context.scene.render.resolution_y = 480  # Output resolution Y
bpy.context.scene.render.film_transparent = False  # Enable transparent background
